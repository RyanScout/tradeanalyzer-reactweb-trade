	...
	return (
		<div>
			...
			<div>
				...
				<input type="Text" id="StockInput" name="StockInput" className="form-control" autoComplete="new-password"
					autoCapitalize="off" onChange={inputStockChange} value={value} />
				<div>
					<input type="submit" name="GetStockButton" id="GetStockButton" className="form-control" value="Get Stock" onClick={stockRequest} />
				</div>
				<label htmlFor="TestField">Buy Amount</label>
				<input type="Text" id="AmountInput" name="AmountInput" className="form-control" autoComplete="new-password"
					autoCapitalize="off" onChange={inputAmountChange} value={amountValue} />
			</div>
			<div>
				<input type="submit" name="BuyButton" id="BuyButton" className="form-control" value="Buy" onClick={buyRequest} />
			</div>
			<div>
...
StocksView.propTypes = {
	...
	amountState: PropTypes.object.isRequired,
	appPrefs: PropTypes.object,
	inputStockChange: PropTypes.func,
	stockRequest: PropTypes.func,
	buyRequest: PropTypes.func
};
